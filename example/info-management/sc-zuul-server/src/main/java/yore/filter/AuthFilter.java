...
import yore.common.exception.BaseException;
import yore.common.exception.BaseExceptionBody;
import yore.common.exception.CommonError;
        ...
        if(StringUtils.isEmpty(userId)) {
            try {
                BaseException BaseException = new BaseException(
                        CommonError.AUTH_EMPTY_ERROR.getCode(),
