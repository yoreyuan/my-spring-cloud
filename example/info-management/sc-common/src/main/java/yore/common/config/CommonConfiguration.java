...
import yore.common.context.SpringCloudHystrixConcurrencyStrategy;
import yore.common.intercepter.FeignUserContextInterceptor;
import yore.common.intercepter.RestTemplateUserContextInterceptor;
import yore.common.intercepter.UserContextInterceptor;

/**
 * 配置类中注册定义的拦截器和并发策略
 *
 * Created by yore on 2019/7/27 22:07
 */
@Configuration
@EnableWebMvc
